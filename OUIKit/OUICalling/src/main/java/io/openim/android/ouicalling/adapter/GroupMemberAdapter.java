 ...
 * 实现微信群视频通话的界面风格和交互逻辑
 */
public class GroupMemberAdapter extends RecyclerView.Adapter<GroupMemberAdapter.WeChatMemberViewHolder> {
    ...
    public GroupMemberAdapter(Context context, CallingVM callingVM, OnMemberClickListener listener) {
        this.context = context;
        this.resourcePool = callingVM.getResourcePool();
        this.callViewModel = callingVM.callViewModel;
    ...
    public GroupMemberAdapter(Context context, VideoResourcePool resourcePool, CallViewModel callViewModel) {
        ...
        this.onMemberClickListener = null;
    }
    ...
    /**
     * 设置RecyclerView引用（兼容性方法）
     */
    public void setRecyclerView(RecyclerView recyclerView) {
        // 该方法用于兼容原有代码，实际功能已内置在适配器中
        L.d(TAG, "setRecyclerView called");
    }
     ...
     */
    public void cleanup() {
        releaseAllVideoRenderers();
        L.d(TAG, "cleanup called");
    }
